...
//        val boardState = BoardState(alice,bob)
//        assertFalse {BoardState.Symbol.O in boardState.board}
//        assertFalse {BoardState.Symbol.X in boardState.board}
//        // insert a symbol into an empty board
//        val newBoard = boardState.writeSymbol(alice,Pair(1,2))
//        assertTrue { BoardState.Symbol.X in newBoard.board}
//        assertTrue { newBoard.board[1] == BoardState.Symbol.X }
//    }
//
//    @Test
